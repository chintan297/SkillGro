    ...
    },
    {
      ...
      icons: [
        ...
        <Instagram
          ...
          className="group-hover:fill-white duration-200"
        />,
        <YoutubeIcon className="group-hover:fill-white duration-200" />,
      ],
      download: true,
    },
  ];
                ...
                <div className="w-6/12 md:w-3/12 px-3" key={index}>
                  ...
                  {data.icons && (
                    <div className="flex items-center gap-x-[15px] mt-[17px]">
                      {data.icons.map((icon, iconIndex) => {
                        return (
                          <a href="#/" className="group" key={iconIndex}>
                            {icon}
                          </a>
                        );
                      })}
                  ...
                  {data.download && (
                    <div className="flex items-center gap-x-2 mt-10">
                      <div className="flex items-center gap-x-4 bg-blue400 p-2.5 rounded-md">
                        <PlayStore />
                        <div className="capitalize font-poppins font-medium">
                          <p className="text-grey200 text-xs leading-none">
                            Get it on
                          </p>
                          <p className="text-white text-sm leading-none mt-1.5">
                            Google play
                          </p>
                        </div>
                      </div>
